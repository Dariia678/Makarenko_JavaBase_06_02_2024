package ua.hillel.makarenko.lessons.lesson8;
...
//        Метод, с помощью которого можно быстро отсортировать цифры
...
//        System.out.println(Arrays.toString(array));
//        System.out.println(Arrays.toString(array2));
//        Пример: Копировать массив и можем скопировать например только 3
//        int[] array = {1, 2, 3, 4, 5};
//        int[] array2 = Arrays.copyOf(array, 3);
//
//        System.out.println(Arrays.toString(array2));
//        Пример: С какого по какой скопировать
